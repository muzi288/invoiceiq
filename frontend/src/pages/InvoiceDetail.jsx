...
import { getInvoice, getInvoiceFile, approveInvoice, rejectInvoice, updateExtracted } from '../services/api'
       ...
       <div className="lg:sticky lg:top-4">
         <div className="bg-gray-900 border border-gray-800 rounded overflow-hidden">
           ...
           {fileLoading ? (
             ...
             <div className="min-h-[70vh] flex items-center justify-center text-red-400 text-sm px-4 text-center">
